...
if st.button('Predict Price'):
    query=pd.DataFrame({'Name':Name,'Company':Company,'City':City,'Year':Year,'KM_Driven':KM_Driven,'No._of_Owners':No_of_Owners,'Fuel_Type':Fuel_Type,'Calculated_Score':Calculated_Score,'Original_Price':Original_Price,'Discount':Discount},index=[0])
